...
[`assets/javascripts/02_bootstrap.js`](/assets/javascripts/02_bootstrap.js) contains all of Bootstrap JavaScript,
...
* Copies all upstream JavaScript into `assets/javascripts/bootstrap`, a Sprockets manifest at `assets/javascripts/bootstrap-sprockets.js`, and a concatenation at `assets/javascripts/02_bootstrap.js`.
